...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LEGOPhotosManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yangqingren/LEGOPhotosManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '564008993@qq.com' => 'yangqingren@yy.com' }
  s.source           = { :git => 'https://github.com/yangqingren/LEGOPhotosManager.git', :tag => s.version.to_s }
